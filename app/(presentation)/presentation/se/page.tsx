...
const SECTIONS = [
  ...
  { id: 'routes', label: 'Rutter' },
  { id: 'subcontractors', label: 'Underleverantörer' },
  { id: 'weather', label: 'Väderprognos' },
  { id: 'more', label: 'Fler funktioner' },
  { id: 'contractors', label: 'Entreprenörer' },
...
/* ═══════════════════════════════════════════
   PAGE
   ═══════════════════════════════════════════ */
export default function PresentationSePage() {
    ...
    <>
      ...
      <section id="overview" style={snap} className="min-h-screen md:h-screen md:overflow-hidden bg-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16">
          <FadeIn>
            <p className="text-primary font-semibold text-sm sm:text-base uppercase tracking-wider mb-2 sm:mb-3">Plattformsöversikt</p>
          ...
          <FadeIn>
            <div className="bg-gradient-to-r from-primary to-primary-600 rounded-xl sm:rounded-2xl p-5 sm:p-8 md:p-12">
              <div className="grid grid-cols-3 gap-4 sm:gap-8 text-center">
                {[
                  { value: '70%', label: 'Mindre kontorsarbete' },
                  { value: '85%', label: 'Mindre tid på fakturering' },
                  { value: '30%', label: 'Lägre driftskostnader' },
                ].map((stat, i) => (
                  <div key={i}>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <FadeIn delay={200}>
            <div className="grid sm:grid-cols-3 gap-6 mt-12">
              {[
                { title: 'GPS-spårning i realtid', desc: 'Se alla teampositioner live på kartan med automatiska statusuppdateringar.' },
                { title: 'Omedelbar omfördelning', desc: 'När en förare är sjuk eller försenad, omfördela uppdrag med ett klick.' },
                { title: 'Komplett spårningslogg', desc: 'Varje åtgärd loggas med tidsstämplar, foton och GPS-verifiering.' },
              ].map((item, i) => (
      ...
      <section id="locations" style={snap} className="min-h-screen md:h-screen md:overflow-hidden bg-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <FadeIn>
                <p className="text-primary font-semibold text-base uppercase tracking-wider mb-3">Platshantering</p>
              ...
              <FadeIn delay={100}>
                <div className="space-y-4">
                  {[
                    { title: 'Ritverktyg', desc: 'Definiera exakta servicegränser på satellitbilder.' },
                    { title: 'Servicezoner', desc: 'Färgkoda olika områden som uppfarter, gångvägar och platser.' },
                    { title: 'Kunduppgifter', desc: 'Spara kontaktinfo, särskilda instruktioner och åtkomstkoder.' },
                    { title: 'Pris per plats', desc: 'Sätt individuell prissättning baserad på arealstorlek och servicetyp.' },
                  ].map((item, i) => (
            ...
            <FadeIn delay={200}>
              <div className="aspect-[4/3] w-full relative rounded-2xl overflow-hidden shadow-2xl">
                <Image src="/presentation/location.png" alt="SnowManager Platshantering" fill className="object-cover" />
              </div>
            </FadeIn>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <FadeIn>
              <div className="aspect-[4/3] w-full relative rounded-2xl overflow-hidden shadow-2xl bg-white">
                <Image src="/presentation/route.png" alt="SnowManager Ruttbyggare" fill className="object-contain" />
              </div>
            </FadeIn>

            <div>
              <FadeIn delay={100}>
                <p className="text-primary-300 font-semibold text-base uppercase tracking-wider mb-3">Smart Ruttbyggare</p>
                <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6">
                  Optimerade rutter på sekunder
                </h2>
                <p className="text-gray-400 text-xl mb-8 leading-relaxed">
                  Bygg de mest effektiva rutterna för dina team. Vår ruttbyggare tar hänsyn till placering, prioritet och utrustning för att minimera körtid och maximera täckning.
                </p>
              </FadeIn>
              ...
              <FadeIn delay={200}>
                <div className="space-y-4">
                  {[
                    { title: 'Dra-och-släpp-redigering', desc: 'Ordna om stopp enkelt med omedelbar ruttomberäkning.' },
                    { title: 'Fördelning på flera team', desc: 'Dela upp rutter över team baserat på kapacitet och närhet.' },
                    { title: 'Prioritetshantering', desc: 'Säkerställ att högprioriterade platser alltid betjänas först.' },
                    { title: 'Automatisk ombalansering', desc: 'Rutter justeras automatiskt när nya uppdrag läggs till.' },
                  ].map((item, i) => (
                    <div key={i} className="flex items-start gap-3">
      ...
      <section id="subcontractors" style={snap} className="min-h-screen md:h-screen md:overflow-hidden bg-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <FadeIn>
                <p className="text-primary font-semibold text-base uppercase tracking-wider mb-3">Underleverantörshantering</p>
                <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-bold text-dark mb-6">
              ...
              <FadeIn delay={100}>
                <div className="space-y-4">
                  {[
                    { title: 'Dedikerad underleverantörsportal', desc: 'Underleverantörer får egen inloggning för att ta emot och slutföra uppdrag.' },
                    { title: 'Spårning i realtid', desc: 'Se underleverantörers framsteg och servicedokumentation löpande.' },
                    { title: 'Automatisk betalningsspårning', desc: 'Tydlig dokumentation eliminerar betalningstvister.' },
                    { title: 'Prestationsöversikt', desc: 'Följ slutförandegrad, svarstider och kvalitetspoäng.' },
                  ].map((item, i) => (
                    <div key={i} className="flex items-start gap-3">
                      <div className="w-6 h-6 bg-primary/10 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                        <svg className="w-3.5 h-3.5 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" /></svg>
            ...
            <FadeIn delay={200}>
              <div className="aspect-[4/3] w-full relative rounded-2xl overflow-hidden shadow-2xl">
                <Image src="/presentation/subcontractor.png" alt="SnowManager Underleverantörshantering" fill className="object-cover" />
              </div>
            </FadeIn>
          </div>
        </div>
      ...
      <section id="weather" style={snap} className="relative min-h-screen md:h-screen md:overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <FadeIn>
              <div className="aspect-[4/3] w-full relative rounded-2xl overflow-hidden shadow-2xl">
                <Image src="/presentation/weather.png" alt="SnowManager Väderprognos" fill className="object-cover" />
              </div>
            </FadeIn>

            <div>
              <FadeIn delay={100}>
                <p className="text-primary-300 font-semibold text-base uppercase tracking-wider mb-3">Live Väderprognos</p>
                <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6">
              ...
              <FadeIn delay={200}>
                <div className="space-y-4">
                  {[
                    { title: 'Hyperlokala prognoser', desc: 'Väderdata specifikt för vart och ett av dina serviceområden.' },
                    { title: 'Vägtemperaturdata', desc: 'Yttemperaturer för att förutsäga isbildning.' },
                    { title: 'Nederbördslarm', desc: 'Bli varnad i god tid när snöfall förväntas.' },
                    { title: 'Historisk väderlogg', desc: 'Fullständig dokumentation av förhållanden för användning vid tvister.' },
                  ].map((item, i) => (
                    <div key={i} className="flex items-start gap-3">
                      <div className="w-6 h-6 bg-primary/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                        <svg className="w-3.5 h-3.5 text-primary-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" /></svg>
      ...
      <section id="more" style={snap} className="min-h-screen md:h-screen md:overflow-hidden bg-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <FadeIn>
            <p className="text-primary font-semibold text-base uppercase tracking-wider mb-3">Och det finns mer</p>
            <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-bold text-dark mb-6">
              Byggt för att driva hela din verksamhet
            </h2>
            <p className="text-gray-500 text-xl max-w-3xl mb-16">
              Utöver kärnfunktionerna innehåller SnowManager allt du behöver för att driva ett professionellt företag och växa din verksamhet.
            </p>
          </FadeIn>

          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: 'Automatisk Fakturering', desc: 'Generera fakturor från utförda uppdrag med GPS-verifierade tidsstämplar och foton som dokumentation.', icon: (<svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" /></svg>) },
              { title: 'Mobilapp', desc: 'Dina fältmedarbetare får en kraftfull app med ett-tryck in/ut-stämpling, navigation och fotodokumentation.', icon: (<svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" /></svg>) },
              { title: 'Kunddashboard', desc: 'Ge kunderna en varumärkesanpassad portal för att se servicehistorik, följa kommande arbete och komma åt rapporter.', icon: (<svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" /></svg>) },
              { title: 'Fotodokumentation', desc: 'Tidsstämplade, geotaggade foton kopplade till varje uppdrag som bevis för utförd service.', icon: (<svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M6.827 6.175A2.31 2.31 0 015.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 00-1.134-.175 2.31 2.31 0 01-1.64-1.055l-.822-1.316a2.192 2.192 0 00-1.736-1.039 48.774 48.774 0 00-5.232 0 2.192 2.192 0 00-1.736 1.039l-.821 1.316z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16.5 12.75a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0z" /></svg>) },
              { title: 'Rit- & Mätverktyg', desc: 'Kartlägg och mät upp serviceområden exakt direkt på satellitbilder för korrekt prissättning.', icon: (<svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.994 15.994 0 011.622-3.395m3.42 3.42a15.995 15.995 0 004.764-4.648l3.876-5.814a1.151 1.151 0 00-1.597-1.597L14.146 6.32a15.996 15.996 0 00-4.649 4.763m3.42 3.42a6.776 6.776 0 00-3.42-3.42" /></svg>) },
              { title: 'Rapportering & Analys', desc: 'Detaljerade rapporter om drift, omsättning och teamprestanda för att hjälpa dig växa.', icon: (<svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" /></svg>) },
            ].map((f, i) => (
              <FadeIn key={i} delay={i * 80}>
      ...
      <section id="contractors" style={snap} className="relative min-h-screen md:h-screen md:overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          <FadeIn>
            <p className="text-primary-300 font-semibold text-base uppercase tracking-wider mb-3">Erkänd i branschen</p>
            <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6">
          ...
          <FadeIn delay={200}>
            <div className="grid sm:grid-cols-3 gap-6">
              {[
                { value: '100+', label: 'Aktiva entreprenörer' },
                { value: '10 000+', label: 'Hanterade platser' },
      ...
      <section id="contact" style={snap} className="relative min-h-screen md:h-screen md:overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          <FadeIn>
            <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6">
              Redo att effektivisera din drift?
            </h2>
            <p className="text-gray-400 text-xl max-w-2xl mx-auto mb-12 leading-relaxed">
              Låt oss visa dig hur SnowManager kan spara dig tid, minska kostnader och hjälpa dig växa din verksamhet. Kontakta oss för en personlig demo.
            </p>
          </FadeIn>
          ...
          <FadeIn delay={100}>
            <div className="grid sm:grid-cols-3 gap-6 mb-8">
              {[
                ...
                {
                  label: 'Hemsida',
                  value: 'snowmanager.se',
                  href: 'https://www.snowmanager.se',
                  icon: (
          ...
          <FadeIn delay={200}>
            <a
              href="mailto:sebastian@snowmanager.com?subject=SnowManager%20Demo%20Förfrågan"
              className="inline-flex items-center gap-2 bg-primary text-white px-8 py-4 rounded-btn text-lg font-semibold hover:bg-primary-600 transition-colors"
            >
              Boka en demo
